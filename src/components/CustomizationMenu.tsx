      ...
      <DialogContent className="max-w-[90vw] w-full h-[80vh] p-0 overflow-hidden bg-stone-100 border-4 border-stone-800 rounded-none shadow-[8px_8px_0px_0px_rgba(0,0,0,0.3)]">
        <div className="flex h-full w-full items-stretch">
                    ...
                    {isApronsOpen && (
                      <div className="grid grid-cols-3 gap-y-8 gap-x-2 py-6">
                        ...
                        <button
                          ...
                          style={{ fontFamily: "'VT323', monospace" }}
                        >
                          <div className={`w-16 h-16 flex items-center justify-center transition-all rounded-lg ${!selectedApron ? 'bg-stone-800/10 scale-110' : 'group-hover:bg-stone-800/5'}`}>
                        ...
                        {APRONS.map((apron) => (
                          ...
                          >
                            <div 
                              className={`w-16 h-16 transition-all flex items-center justify-center rounded-lg ${selectedApron === apron.src ? 'bg-stone-800/10 scale-110' : 'group-hover:bg-stone-800/5'}`}
                            >
                              <div 
                                className="w-16 h-16"
                                style={{ 
          ...
          <div className="flex-1 relative bg-[radial-gradient(circle,_var(--tw-gradient-stops))] from-stone-300/50 to-transparent overflow-hidden">
            {/* Fixed Preview Container - Using absolute positioning to prevent any layout shifts */}
