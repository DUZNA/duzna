...
const APRONS: { name: string; set: ApronSet }[] = [
  { name: 'Yellow', set: { idle: yellowIdle, walk: yellowWalk, run: yellowRun, backslash: yellowBacklash, climb: yellowClimb, combat_idle: yellowCombatIdle, emote: yellowEmote, halfslash: yellowHalfslash, hurt: yellowHurt, jump: yellowJump, shoot: yellowShoot, sit: yellowSit, slash: yellowSlash, spellcast: yellowSpellcast, thrust: yellowThrust } },
  { name: 'Black', set: { idle: blackIdle, walk: blackWalk, run: blackRun, backslash: blackBacklash, climb: blackClimb, combat_idle: blackCombatIdle, emote: blackEmote, halfslash: blackHalfslash, hurt: blackHurt, jump: blackJump, shoot: blackShoot, sit: blackSit, slash: blackSlash, spellcast: blackSpellcast, thrust: blackThrust } },
  { name: 'Blue', set: { idle: blueIdle, walk: blueWalk, run: blueRun, backslash: blueBacklash, climb: blueClimb, combat_idle: blueCombatIdle, emote: blueEmote, halfslash: blueHalfslash, hurt: blueHurt, jump: blueJump, shoot: blueShoot, sit: blueSit, slash: blueSlash, spellcast: blueSpellcast, thrust: blueThrust } },
  { name: 'Blue Gray', set: { idle: bluegrayIdle, walk: bluegrayWalk, run: bluegrayRun, backslash: bluegrayBacklash, climb: bluegrayClimb, combat_idle: bluegrayCombatIdle, emote: bluegrayEmote, halfslash: bluegrayHalfslash, hurt: bluegrayHurt, jump: bluegrayJump, shoot: bluegrayShoot, sit: bluegraySit, slash: bluegraySlash, spellcast: bluegraySpellcast, thrust: bluegrayThrust } },
  { name: 'Brown', set: { idle: brownIdle, walk: brownWalk, run: brownRun, backslash: brownBacklash, climb: brownClimb, combat_idle: brownCombatIdle, emote: brownEmote, halfslash: brownHalfslash, hurt: brownHurt, jump: brownJump, shoot: brownShoot, sit: brownSit, slash: brownSlash, spellcast: brownSpellcast, thrust: brownThrust } },
  { name: 'Charcoal', set: { idle: charcoalIdle, walk: charcoalWalk, run: charcoalRun, backslash: charcoalBacklash, climb: charcoalClimb, combat_idle: charcoalCombatIdle, emote: charcoalEmote, halfslash: charcoalHalfslash, hurt: charcoalHurt, jump: charcoalJump, shoot: charcoalShoot, sit: charcoalSit, slash: charcoalSlash, spellcast: charcoalSpellcast, thrust: charcoalThrust } },
  { name: 'Forest', set: { idle: forestIdle, walk: forestWalk, run: forestRun, backslash: forestBacklash, climb: forestClimb, combat_idle: forestCombatIdle, emote: forestEmote, halfslash: forestHalfslash, hurt: forestHurt, jump: forestJump, shoot: forestShoot, sit: forestSit, slash: forestSlash, spellcast: forestSpellcast, thrust: forestThrust } },
  { name: 'Gray', set: { idle: grayIdle, walk: grayWalk, run: grayRun, backslash: grayBacklash, climb: grayClimb, combat_idle: grayCombatIdle, emote: grayEmote, halfslash: grayHalfslash, hurt: grayHurt, jump: grayJump, shoot: grayShoot, sit: graySit, slash: graySlash, spellcast: graySpellcast, thrust: grayThrust } },
  { name: 'Green', set: { idle: greenIdle, walk: greenWalk, run: greenRun, backslash: greenBacklash, climb: greenClimb, combat_idle: greenCombatIdle, emote: greenEmote, halfslash: greenHalfslash, hurt: greenHurt, jump: greenJump, shoot: greenShoot, sit: greenSit, slash: greenSlash, spellcast: greenSpellcast, thrust: greenThrust } },
  { name: 'Lavender', set: { idle: lavenderIdle, walk: lavenderWalk, run: lavenderRun, backslash: lavenderBacklash, climb: lavenderClimb, combat_idle: lavenderCombatIdle, emote: lavenderEmote, halfslash: lavenderHalfslash, hurt: lavenderHurt, jump: lavenderJump, shoot: lavenderShoot, sit: lavenderSit, slash: lavenderSlash, spellcast: lavenderSpellcast, thrust: lavenderThrust } },
  { name: 'Leather', set: { idle: leatherIdle, walk: leatherWalk, run: leatherRun, backslash: leatherBacklash, climb: leatherClimb, combat_idle: leatherCombatIdle, emote: leatherEmote, halfslash: leatherHalfslash, hurt: leatherHurt, jump: leatherJump, shoot: leatherShoot, sit: leatherSit, slash: leatherSlash, spellcast: leatherSpellcast, thrust: leatherThrust } },
  { name: 'Maroon', set: { idle: maroonIdle, walk: maroonWalk, run: maroonRun, backslash: maroonBacklash, climb: maroonClimb, combat_idle: maroonCombatIdle, emote: maroonEmote, halfslash: maroonHalfslash, hurt: maroonHurt, jump: maroonJump, shoot: maroonShoot, sit: maroonSit, slash: maroonSlash, spellcast: maroonSpellcast, thrust: maroonThrust } },
  { name: 'Navy', set: { idle: navyIdle, walk: navyWalk, run: navyRun, backslash: navyBacklash, climb: navyClimb, combat_idle: navyCombatIdle, emote: navyEmote, halfslash: navyHalfslash, hurt: navyHurt, jump: navyJump, shoot: navyShoot, sit: navySit, slash: navySlash, spellcast: navySpellcast, thrust: navyThrust } },
  { name: 'Orange', set: { idle: orangeIdle, walk: orangeWalk, run: orangeRun, backslash: orangeBacklash, climb: orangeClimb, combat_idle: orangeCombatIdle, emote: orangeEmote, halfslash: orangeHalfslash, hurt: orangeHurt, jump: orangeJump, shoot: orangeShoot, sit: orangeSit, slash: orangeSlash, spellcast: orangeSpellcast, thrust: orangeThrust } },
  { name: 'Pink', set: { idle: pinkIdle, walk: pinkWalk, run: pinkRun, backslash: pinkBacklash, climb: pinkClimb, combat_idle: pinkCombatIdle, emote: pinkEmote, halfslash: pinkHalfslash, hurt: pinkHurt, jump: pinkJump, shoot: pinkShoot, sit: pinkSit, slash: pinkSlash, spellcast: pinkSpellcast, thrust: pinkThrust } },
  { name: 'Purple', set: { idle: purpleIdle, walk: purpleWalk, run: purpleRun, backslash: purpleBacklash, climb: purpleClimb, combat_idle: purpleCombatIdle, emote: purpleEmote, halfslash: purpleHalfslash, hurt: purpleHurt, jump: purpleJump, shoot: purpleShoot, sit: purpleSit, slash: purpleSlash, spellcast: purpleSpellcast, thrust: purpleThrust } },
  { name: 'Red', set: { idle: redIdle, walk: redWalk, run: redRun, backslash: redBacklash, climb: redClimb, combat_idle: redCombatIdle, emote: redEmote, halfslash: redHalfslash, hurt: redHurt, jump: redJump, shoot: redShoot, sit: redSit, slash: redSlash, spellcast: redSpellcast, thrust: redThrust } },
  { name: 'Rose', set: { idle: roseIdle, walk: roseWalk, run: roseRun, backslash: roseBacklash, climb: roseClimb, combat_idle: roseCombatIdle, emote: roseEmote, halfslash: roseHalfslash, hurt: roseHurt, jump: roseJump, shoot: roseShoot, sit: roseSit, slash: roseSlash, spellcast: roseSpellcast, thrust: roseThrust } },
  { name: 'Sky', set: { idle: skyIdle, walk: skyWalk, run: skyRun, backslash: skyBacklash, climb: skyClimb, combat_idle: skyCombatIdle, emote: skyEmote, halfslash: skyHalfslash, hurt: skyHurt, jump: skyJump, shoot: skyShoot, sit: skySit, slash: skySlash, spellcast: skySpellcast, thrust: skyThrust } },
  { name: 'Slate', set: { idle: slateIdle, walk: slateWalk, run: slateRun, backslash: slateBacklash, climb: slateClimb, combat_idle: slateCombatIdle, emote: slateEmote, halfslash: slateHalfslash, hurt: slateHurt, jump: slateJump, shoot: slateShoot, sit: slateSit, slash: slateSlash, spellcast: slateSpellcast, thrust: slateThrust } },
  { name: 'Tan', set: { idle: tanIdle, walk: tanWalk, run: tanRun, backslash: tanBacklash, climb: tanClimb, combat_idle: tanCombatIdle, emote: tanEmote, halfslash: tanHalfslash, hurt: tanHurt, jump: tanJump, shoot: tanShoot, sit: tanSit, slash: tanSlash, spellcast: tanSpellcast, thrust: tanThrust } },
  { name: 'Teal', set: { idle: tealIdle, walk: tealWalk, run: tealRun, backslash: tealBacklash, climb: tealClimb, combat_idle: tealCombatIdle, emote: tealEmote, halfslash: tealHalfslash, hurt: tealHurt, jump: tealJump, shoot: tealShoot, sit: tealSit, slash: tealSlash, spellcast: tealSpellcast, thrust: tealThrust } },
  { name: 'Walnut', set: { idle: walnutIdle, walk: walnutWalk, run: walnutRun, backslash: walnutBacklash, climb: walnutClimb, combat_idle: walnutCombatIdle, emote: walnutEmote, halfslash: walnutHalfslash, hurt: walnutHurt, jump: walnutJump, shoot: walnutShoot, sit: walnutSit, slash: walnutSlash, spellcast: walnutSpellcast, thrust: walnutThrust } },
  { name: 'White', set: { idle: whiteIdle, walk: whiteWalk, run: whiteRun, backslash: whiteBacklash, climb: whiteClimb, combat_idle: whiteCombatIdle, emote: whiteEmote, halfslash: whiteHalfslash, hurt: whiteHurt, jump: whiteJump, shoot: whiteShoot, sit: whiteSit, slash: whiteSlash, spellcast: whiteSpellcast, thrust: whiteThrust } },
];
